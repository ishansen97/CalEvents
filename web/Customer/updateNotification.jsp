        ...
        <div class="container">
            ...
            <div class="photo-section">
                ...
                <div align="center">
                    ...
                    <h><b>Update your notifications</b></h>
                    <br><br>
                    <%
                    ...
                    <%
                        try {
                            ...
                            String sql = "SELECT *  FROM  notification where userID=" + session.getAttribute("id");

                            rs = st.executeQuery(sql);
                            while (rs.next()) {
                    %>

                    <form method="post" action="updateNotificaionServelet">

                        <br>
                        Nid :
                        <input type="text" name="nid"  value="<%=rs.getString("nid")%>" readonly>


                        Notify :
                        <input type="text" name="notify" value="<%=rs.getString("notify")%>">
                        <br><br>
