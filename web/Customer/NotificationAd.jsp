        ...
        <div class="container">
            ...
            <div class="photo-section">
                ...
                <div align="center">
                    ...
                    <button class="btn btn-danger" value="Add notification" onclick="location.href = 'addNotifications.jsp'"<%=resultSet.getString("userID")%>>Add Notification</button>
                    <br><br><button class="btn btn-danger" value="Send Email" onclick="location.href = 'email.jsp'"<%=resultSet.getString("userID")%>>Send email</button>
                    ...
                    <table border="2" class="table-hover" cellpadding="50">
                        ...
                        <%
                            try {
                                con = DBConnection.createConnection();
                                statement = con.createStatement();
                                String sqll = "SELECT * FROM  notification";
                        ...
                        <tr>
                            ...
                            <td><input type="submit" value="update" onclick="location.href = 'updateNotification.jsp?nid=<%=resultSet.getString("nid")%>'"/></td>

                            <td><form action="DeleteNotification" method="post">
