            ...
            <div class="photo-section">
                ...
                <div align="center">
                    ...
                    <form method="post" action="updateFeedbackServlet">
                        ...
                        Name : <br><label>
                            <input type="text" name="name"  value="<%=rs.getString("name")%>" readonly></label>
                        <br>
                        User ID <br><label>
                            <input type="text" name="userid" value="<%=rs.getString("userid")%>"readonly></label>
                        <br>
                        Email :<br><label>
                            <label for="transpType">
                                <input type="text" name="email" value="<%=rs.getString("email")%>" readonly></label>
                        </label>
                        <br>
                        Subject :<br>
                        ...
                        <br>
                        Comments :<br>
                        <input type="text" name="comments" value="<%=rs.getString("comments")%>">
                        <br><br>
