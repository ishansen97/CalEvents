                ...
                <div align="center">
                    ...
                    <form method="post" action="UpdateProfileServlet">
                        ...
                        <div class="form-group">
                            ...
                            &nbsp;<input type="text" class="form-control" pattern="[a-zA-Z\s]+" title=" Enter letters only" id="fn" name="user" value="<%=resultSet.getString("username")%>">
                        </div><br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cn" maxlength="10" pattern="[0-9\s]+" title=" Enter numbers only" value="<%=resultSet.getString("contactNo")%>">
                        </div><br>
                        <div class="form-group">
