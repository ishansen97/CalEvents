                ...
                <div align="center">
                    ...
                    <form method="POST" action="EmailServlet" >
                        <table class="table-hover"  cellpadding="10">
                            <tr><td>To                  :&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input id="to" name="to" type="text" value=<%=resultSet.getString("email")%>></label></td></tr> <br/>
                            <tr><td>Subject: <input id="subject" name="subject" type="text"/></td></tr> <br/><br>
                            <tr><td> &nbsp&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="body" cols="60" rows="15" placeholder="Message" ></textarea></td></tr><br/>
