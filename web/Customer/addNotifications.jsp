...
<div class="container">
    ...
    <div class="photo-section">
        <div class="photo-title">
            <div class="title"><a href="AdminProfile.jsp">My Profile</a></div>
            
            <div class="title"><a href="bookedEventsAd.jsp">Booked Events</a></div>
            <div class="title"><a href="FeedbackAd"><u>Feedback</u></a></div>
            <div class="title"><a href="Ad.jsp">Notifications</a></div>
        ...
        <div align="center">
            ...
            <form name="form" action="AddNotification" method="post" > 
                <br><br>
                <table>
                    ...
                    <tr>
                        <td><b>Notify</b></td>
                        <td><textarea rows="10" name="notify" cols="18" required></textarea></td>  <%-- validate empty fields--%> 
                    </tr>
                    <tr>
                        <td><b>User ID</b></td>
                        <td><input type="text" name="userID" value=></td>  <%-- validate empty fields--%> 
                    </tr>
