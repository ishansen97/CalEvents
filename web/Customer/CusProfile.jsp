        ...
        <div class="container">
            ...
            <div class="photo-section">
                ...
                <div align="center">
                    ...
                    <p><strong><big>Full name: </big></strong><%=resultSet.getString("name")%></p>
                    ...
                    <p><strong><big>Email:</big> </strong><%=resultSet.getString("email")%></p>
                    <br><br>
                    ...
                    <button class="btn btn-success"  onclick="location.href = 'updateProfile.jsp?userID=<%=session.getAttribute("id")%>'"/>Edit Your Profile
                    </button>
                </div>
