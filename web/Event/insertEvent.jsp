    <%-- 
    Document   : insertEventTest
    Created on : Sep 6, 2018, 12:16:59 PM
    Author     : hp
--%>
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="container-fluid"  style="padding-top:22px">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">New Public Event</li>
                </ol>

                <div class="container-fluid mb-3 bg-white">
                    <p style="color:black;font-size:50px;text-align:center">Insert Public Events</p>
                    <form action="<%=request.getContextPath()%>/MyServlet" method="post" onsubmit="return validation()">
                                ...
                                <div class='form-row mb-2'>
                                    <div class='form-group col-lg-12'>
                                        <div class='input-group'>
                                            ...
                                            <textarea rows="4" class='form-control rounded-0 border border-left-0 form-control-lg' name="description" id="desc" placeholder="Event Description" required></textarea>
                                        </div>
                                    </div>
                                </div>  
                                ...
                                <div class='form-row mb-2'>
                                    <div class='form-group col-lg-12'>
                                        <div class='input-group'>
                                            ...
                                            <input type='date' class='form-control rounded-0 border border-left-0 form-control-lg' name="start_date" id="start" placeholder="Date" onchange="display()" required>
                                            <p id="isAvailable"></p>
                                        </div>
                                    </div>
                                </div>
                                <div class='form-row mb-2'>
                                    <div class='form-group col-lg-6'>
                                        ...
                                        <div class='input-group'>
                                            ...
                                            <input type='time' min="<%=request.getAttribute("start_time").toString()%>" max="23:59" class='form-control rounded-0 border border-left-0 form-control-lg' name="start_time" id="start_time" placeholder="Start Time" onchange="checkStartTime()" required>
                                        </div>
                                    </div>

                                    <div class='form-group col-lg-6'>
                                        <label style="color:black;font-size:20px;text-align:left">End Time: </label> 
                                        <input type='time' class='form-control rounded-0 form-control-lg' name="end_time" id="end_time" placeholder="End Time" required>
