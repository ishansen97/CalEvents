...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    <div class="w3-col s4">
      <img src="images/SB.PNG" class="w3-circle w3-margin-right" style="width:46px">
    </div>
  ...
  <div class="w3-bar-block">
    ...
    <a href="calendarview.jsp" class="w3-bar-item w3-button w3-padding w3-blue" style="text-decoration: none"><i class="fa fa-users fa-fw"></i>&nbsp; Calendar</a>
