  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr><%while(tentsV.next()){%>
          ...
          <td><a href="updateFacility.jsp?event_id=<%=tentsV.getString("facilityID") %>" class="btn btn-success">Update</a></td>
          <td><a href="deleteFacility.jsp?event_id=<%=tentsV.getString("facilityID") %>" class="btn btn-danger">Delete</a></td>
      </tr><%}%>
