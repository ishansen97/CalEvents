...
<button class="w3-bar-item w3-button" onclick="openCity('tentTable')">Tents</button>
<button class="w3-bar-item w3-button" onclick="openCity('soundsTable')">Sounds</button>
<button class="w3-bar-item w3-button" onclick="openCity('lightsTable')">Lights</button>
<button class="w3-bar-item w3-button" onclick="openCity('kitchenTable')">Kitchen Utensils</button>
<button class="w3-bar-item w3-button" onclick="openCity('tablesTable')">Tables</button>
<button class="w3-bar-item w3-button" onclick="openCity('chairsTable')">Chairs</button>
</div>
        
        
<div id="tentTable" class="w3-container city" style="margin-left: 0%; margin-top: 0%;">
...
<div id="soundsTable" class="w3-container city"  style="display: none;">
...
<div id="lightsTable" class="w3-container city"  style="display: none;">
...
<div id="kitchenTable" class="w3-container city"  style="display: none;">
...
<div id="tablesTable" class="w3-container city"  style="display: none;">
...
<div id="chairsTable" class="w3-container city"  style="display: none;">
