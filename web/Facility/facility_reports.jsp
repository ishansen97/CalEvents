...
<div>
     ...
     <div class="col-sm-8 col-md-6">
        <div class="card text-white bg-info mb-3" style="max-width:45%; max-height: 50%; align-content: right">
            ...
            <div class="card-body">
                <
                <a href="#" class="btn btn-success">Get the report</a>
            </div>
        </div>
        </div>
            ...
            <div class="col-sm-8 col-md-6">
                    <div class="card text-white bg-info mb-3" style="max-width: 45%; max-height: 50%; align-content: right">
            <div class="card-header">Facility Packages</div>
            <div class="card-body">
            ...
            <div class="card-header">Facility Requests</div>
            <div class="card-body">
