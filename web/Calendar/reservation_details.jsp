<%-- 
    Document   : reservation_details
    Created on : Sep 6, 2018, 10:57:38 AM
    Author     : DELL
--%>
        ...
        <div class="w3-main" style="margin-top: 50px; margin-left: 300px">
            <div class="container">
                ...
                <div class="row" style="margin-top: 10px">
                   ...
                   <!--ticket price update modal -->
                   <div class="modal fade" id="test">
                       <div class="modal-dialog">
                           <div class="modal-content">
                               <div class="modal-header">
                                   <h1 class="modal-title">Ticket Price</h1>
                                   <button type="button" class="close" data-dismiss="modal">&times;</button>
                               </div>    
                                <!--modal body -->
                                <div class="modal-body">
                                    <form action="<%=request.getContextPath() %>/UpdateTicketPricesServlet" method="POST">
                                        <table class="table table-success table-hover">
                                            <tr>
                                                <th>Seat range</th>
                                                <th>Price(in $)</th>
                                            ...
                                            <tr>
                                                <td>1 - 5</td>
                                                <td class="price"><input type="number" min="0" max="100" id="price1" name="first_price" required></td>
                                                <td><span class="status1"></span></td>
                                            </tr>
                                            <tr>
                                                <td>6 - 10</td>
                                                <td class="price"><input type="number" min="0" max="100" id="price2" name="second_price" required></td>
                                                <td><span class="status2"></span></td>
                                            </tr>
                                            <tr>
                                                <td>11 - 15</td>
                                                <td class="price"><input type="number" min="0" max="100" id="price3" name="third_price" required></td>
                                                <td><span class="status3"></span></td>
                                            </tr>
                                            <tr>
                                                <td><input type="hidden" name="event_id" value="<%=event_id %>"></td>
                   ...
                   <!--end of ticket price update modal -->
