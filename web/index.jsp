    ...
    <body>
        ...
        <div class="w3-top w3-hide-small">
            <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
                ...
                <a href="#bookEvent" class="w3-bar-item w3-button">RESERVATIONS</a>
            </div>
        </div>
        ...
        <div class="w3-container w3-padding-64 w3-blue-grey w3-grayscale-min w3-xlarge" id="bookEvent">
            <div class="w3-content">
                <h1 class="w3-center w3-jumbo" style="margin-bottom:64px">book an event</h1>
                <p class="w3-xxlarge"><strong>Reserve</strong> a date for your event, fill out the from below or call us at 05050515-122330</p>

                <form action="<%=request.getContextPath()%>/MyServletPrivate" method="post" onsubmit="return validation()">

                    <label>Event Name</label>
                    <input class="w3-input w3-padding-large w3-margin-bottom" type="text" name="eventName" required style="font-family: 'Raleway', sans-serif; color: black">

                    <div class="w3-row-padding w3-margin-bottom" style="padding-left: 0px; padding-right: 0px;">
                        <div class="w3-half" style="padding-left: 0px;">
                            <label>start time</label>
                            <input class="w3-input w3-border w3-padding-large w3" type="time" name="start_time" id="st_STime" required style="font-family: 'Raleway', sans-serif; color: black">
                        </div>
                        <div class="w3-half" style="padding-right: 0px;">
                            <label>end time</label>
                            <input class="w3-input w3-border w3-padding-large w3" type="time" name="end_time" id="ed_Time" required style="font-family: 'Raleway', sans-serif; color: black">
                        </div>
                    </div>


                    <label>expected crowd</label>
                    <input class="w3-input w3-padding-large w3-margin-bottom" type="number" name="crowdE" min="0" max="500" required style="font-family: 'Raleway', sans-serif; color: black">

                    <div class="w3-row-padding w3-margin-bottom" style="padding-left: 0px; padding-right: 0px;">
                        <div class="w3-half" style="padding-left: 0px;">
                            <label>date</label>
                            <input class="w3-input w3-border w3-padding-large w3" type="date" name="date" id="st_date" required style="font-family: 'Raleway', sans-serif; color: black">
                        </div>
                        <div class="w3-half" style="padding-right: 0px;">
                            <label>location</label>
                            <select class="w3-select w3-border w3-padding-16" name="location" required style="font-family: 'Raleway', sans-serif; color: black">
                    ...
                    <input class="w3-input w3-padding-large w3-margin-bottom" type="text" name="CustomerName" required style="font-family: 'Raleway', sans-serif; color: black">

                    <label>email</label>
                    <input class="w3-input w3-padding-large w3-margin-bottom" type="text" name="email" required style="font-family: 'Raleway', sans-serif; color: black">

                    <label>contact number</label>
                    <input class="w3-input w3-padding-large" type="text" name="phoneNo" required style="font-family: 'Raleway', sans-serif; color: black">
                    
                    <button class="w3-button w3-light-grey w3-block" style="margin-top:25px" type="submit" name="submit" required>Submit request</button>
