<%-- 
    Document   : update
    Created on : Aug 31, 2018, 10:51:04 PM
    Author     : Lini Eisha
--%>
            ...
            <div class="col-6">
                <form action="../updateQuantity" method="POST" onclick="submit">
                    <table>
                        ...
                        <tr>
                            <td align="right"><button class="button" name="addR" value='add'>ADD</button></td>
                            <td align="right"><button class="button" name='removeR' value="remove">Remove</button></td>
                        </tr>
                    </table>
                </form>
            </div>
