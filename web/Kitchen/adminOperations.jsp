                        ...
                        <div class="col-sm-8" style="overflow-y:scroll; height:400px;" >
                            <table class="table" border="3" width="90%" cellspacing="5" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center"><a href="updateRaw.jsp?nameU=<%=dataU.getString("name")%>" class="btn btn-warning" value="<%=dataU.getString("name")%>" >Update</a></td> 
                            ...
                            <script>
                                function displayModal(obj) {
                                    ...
                                    $.post("updateRaw.jsp", {raw_ID: rawID}, function (data) {
