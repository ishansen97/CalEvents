...
public class reportFeedbackServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
            ...
            String reportPath = "G:\\Yr 2 Semester 2\\ITP\\Grp project\\WebApplication4\\src\\java\\report\\FeedbackAd.jrxml";
...
//////                //creating a JasperPrint object to fill the report
            JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, con);
                ...
                JasperExportManager.exportReportToPdfFile(jasperPrint, "C://Users//Shashi Perera//Desktop//report//FeedbackAd.pdf");
//         
           response.sendRedirect("FeedbackAd.jsp");
