...
public class CreatePackage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String[] facilities = request.getParameterValues("fac");
            ...
            Packages p = new Packages(name, priced, facilities);
            ...
            try {
                ...
                Logger.getLogger(CreatePackage.class.getName()).log(Level.SEVERE, null, ex);
